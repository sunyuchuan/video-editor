...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public void changeResolution(int index) {
        _changeResolution(index);
    }

    private native void _changeResolution(int index);

    public void setLiveStream(int isLiveStream) {
        _setLiveStreamFlag(isLiveStream);
    }

    private native void _setLiveStreamFlag(int isLiveStream);

    public void muxStream(String[] inputPaths, String outputPath) {
        _muxStream(inputPaths, outputPath);
    }

    private native void _muxStream(String[] inputPaths, String outputPath);

    public void clipStream(String inPath, String outPath, long startTime, long endTime) {
        _clipStream(inPath, outPath, startTime, endTime);
    }

    private native void _clipStream(String inPath, String outPath, long startTime, long endTime);
    /**
