...
public interface IMediaPlayer {
    ...
    int MEDIA_INFO_MUX_SUCCESS = 803;
    int MEDIA_INFO_MUX_PROGRESS = 804;
    int MEDIA_INFO_CLIP_SUCCESS = 805;
    int MEDIA_INFO_CLIP_PROGRESS = 806;
