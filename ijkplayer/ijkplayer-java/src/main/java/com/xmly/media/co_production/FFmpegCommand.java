...
class FFmpegCommand {
    ...
    public static int generate_aac(String out_file_path, long duration_in_ms) {
        if (out_file_path == null) {
            return -1;
        }
        return native_generate_aac(out_file_path, duration_in_ms);
    }

    private static native int native_generate_aac(String out_file_path, long duration_in_ms);
