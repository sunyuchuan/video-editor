...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    public GPUImageFilterGroup(List<GPUImageFilter> filters) {
        ...
        float[] flipTexture = TextureRotationUtil.getRotation(Rotation.ROTATION_180, true, false);
    ...
    public int onDrawToTexture(final int textureId, final FloatBuffer cubeBuffer,
        ...
        int ret = OpenGlUtils.NO_TEXTURE;
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (i == 0) {
                    if(isNotLast) {
                        ...
                        ret = filter.onDrawToTexture(previousTexture, cubeBuffer, textureBuffer);
                    }
                } else if (i == size - 1) {
                    ret = filter.onDrawToTexture(previousTexture, mGLCubeBuffer, (size % 2 == 0) ? mGLTextureFlipBuffer : mGLTextureBuffer);
                } else {
