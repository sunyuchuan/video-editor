    ...
    public static GPUImageFilter CreateFilter(XMFilterType filterType) {
        ...
        switch(filterType) {
            ...
            case FILTER_MIRROR:
                ...
                break;
            case FILTER_LOGO:
                filter = new GPUImageLogoFilter();
                filter.setBitmap(decodeBitmap("/sdcard/watermark.png"));
                filter.setRectangleCoordinate(new float[]{0.55f,0.55f,0.95f,0.95f});
                break;
            case FILTER_IMAGE_SWITCH:
                filter = new GPUImageImageSwitchFilter();
                break;
            case FILTER_BLINDS:
