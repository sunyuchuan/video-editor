...
public class XMMediaRecorder {
    ...
    public void glMapBufferRange_put(int target, int offset, int length,
        ...
        _glMapBufferRange_put(target, offset, length, access, w, h, pixelStride, rowPadding);
    }
    ...
    private native void _glMapBufferRange_put(int target, int offset, int length, int access, int w, int h, int pixelStride, int rowPadding);
