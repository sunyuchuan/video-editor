    ...
    public void onClick(final View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.concat_test:
                ...
                try {
                    ArrayList<VideoSynthesis.ImageData> imagelist = new ArrayList<VideoSynthesis.ImageData>();
                    imagelist.add(new VideoSynthesis.ImageData("/sdcard/out1.png", 2500));
                    imagelist.add(new VideoSynthesis.ImageData("/sdcard/out2.png", 2500));
                    imagelist.add(new VideoSynthesis.ImageData("/sdcard/out3.png", 2500));
                    imagelist.add(new VideoSynthesis.ImageData("/sdcard/out4.png", 2500));
                    imagelist.add(new VideoSynthesis.ImageData("/sdcard/out5.png", 2500));
                    imagelist.add(new VideoSynthesis.ImageData("/sdcard/out6.png", 2500));
                    VideoSynthesis.getInstance().image2Video(imagelist, "/sdcard/watermark.png",
                            "/sdcard/dubshow.m4a","/sdcard/image2video.mp4",640,480,new VideoSynthesis.Rect(0.5f,0.5f,0.9f,0.9f),mOnVideoSynthesisListener);
