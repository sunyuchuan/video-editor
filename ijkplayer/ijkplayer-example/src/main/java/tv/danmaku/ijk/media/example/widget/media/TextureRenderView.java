...
public class TextureRenderView extends TextureView implements IRenderView {
    ...
    private void initView(Context context) {
        ...
        Log.d("TextureRenderView", "use texture view ....");
    }
    ...
    protected void onDetachedFromWindow() {
        mSurfaceCallback.willDetachFromWindow(true);
        try {
            super.onDetachedFromWindow();
        } catch (Exception e) {
            e.printStackTrace();
        }
        mSurfaceCallback.didDetachFromWindow(true);
    }
    ...
    private static final class InternalSurfaceHolder implements IRenderView.ISurfaceHolder {
        ...
        public void bindToMediaPlayer(IMediaPlayer mp) {
            ...
            if ((Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) &&
                ...
                mTextureView.mSurfaceCallback.willDetachFromWindow(false);
                mTextureView.mSurfaceCallback.didDetachFromWindow(false);
    ...
    private static final class SurfaceCallback implements SurfaceTextureListener, ISurfaceTextureHost {
        ...
        public synchronized boolean getOwnSurfaceTexture() {
            return mOwnSurfaceTexture;
        }

        public synchronized void setOwnSurfaceTexture(boolean ownSurfaceTexture) {
        ...
        public void releaseSurfaceTexture(SurfaceTexture surfaceTexture) {
            ...
            } else if (getWillDetachFromWindow()) {
                if (surfaceTexture != mSurfaceTexture) {
        ...
        public synchronized boolean getWillDetachFromWindow() {
            return mWillDetachFromWindow;
        }

        public synchronized boolean getDidDetachFromWindow() {
            return mDidDetachFromWindow;
        }

        public synchronized void willDetachFromWindow(boolean status) {
            Log.d(TAG, "willDetachFromWindow() status " + status);
            mWillDetachFromWindow = status;
        }

        public synchronized void didDetachFromWindow(boolean status) {
            Log.d(TAG, "didDetachFromWindow() status " + status);
            mDidDetachFromWindow = status;
        }
    }
